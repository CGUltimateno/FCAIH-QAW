...
$comm_id = isset($_GET['comm_id']) ? $_GET['comm_id'] : null;
            ...
            <div class="container-fluid">
                <div class="row">
                                                ...
                                                ?><div class="col-md-6">
                                                        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
															...
															<div class="card-body d-flex flex-column align-items-start">
																...
																<small class="card-text mb-auto"><?= __('Created By')?> <?php echo $row['username'] ?></small>
																<a href="posts.php?topic= <?php echo $row['q_id'] ?>"><?= __('Go to Question')?></a>
															</div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="question.php?comm_id=<?php echo $comm_id; ?>" class="btn btn-warning btn-lg btn-block"><?= __('Ask Question')?></a>
