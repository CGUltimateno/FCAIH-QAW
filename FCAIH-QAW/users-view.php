                  ...
                  <?php
                      ...
                      else
                      {
                          ...
                          while ($row = mysqli_fetch_assoc($result))
                          {
                            ...
                            echo '<a href="profile.php?id='.$row['id'].'"><img src="'.$row['img'].'" alt="" class="mr-2 rounded-circle div-img list-user-img"></a>';
                            echo '<p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">';
                            echo '<strong class="d-block text-gray-dark"><a href="profile.php?id='.$row['id'].'">'.ucwords($row['username']).'</a></strong>';
                            echo '<span class="text-primary">'.ucwords($row['f_name'].' '.$row['l_name']).'</a></span><br>';
                            echo $row['email'];
                            echo '</p>';
                            echo '<div class="align-self-center">';
                            echo '<a href="#" class="btn btn-link text-danger" data-toggle="modal" data-target="#reportModal" data-id="'.$row['id'].'">';
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="reportForm" action="report.php" method="post">
                            ...
                            <input type="hidden" id="reported_user_id" name="id" value="<?php ['$row'] ?>">
